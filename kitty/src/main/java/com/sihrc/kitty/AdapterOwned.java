 ...
 */
public class AdapterOwned extends ArrayAdapter{
    //Show CheckBox?
    Boolean checkbox;
    ...
    //Public Constructor
    public AdapterOwned(Activity activity, ArrayList<Kitty> kitties, Boolean checkbox){
        super(activity, R.layout.listitem_owned_kitty, kitties);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ResizableImageView image = (ResizableImageView) convertView.findViewById(R.id.listitem_owned_kitty_image);
        image.setScaleType(ImageView.ScaleType.CENTER_CROP);
        image.setImageBitmap(BitmapFactory.decodeByteArray(kitty.image, 0, kitty.image.length));

        TextView name = (TextView) convertView.findViewById(R.id.listitem_owned_kitty_name);
        TextView category = (TextView) convertView.findViewById(R.id.listitem_owned_kitty_category);
        TextView status = (TextView) convertView.findViewById(R.id.listitem_owned_kitty_status);
